@extends('layouts.adminindex')
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                <a href="{{route('relatives.create')}}" class="btn btn-primary btn-sm rounded-0">Create</a>
            </div>
                        ...
                        <tbody>
                            @foreach ($relatives as $idx=>$relative)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('relatives.edit',$relative->id)}}" class="text-info "><i class="fas fa-pen"></i></a>
