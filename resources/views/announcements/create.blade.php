                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control form-control-sm rounded-0" placeholder="Enter Anoucment title" value="{{old('title')}}" />
                                </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                console.log("Flatpickr initialized.");
                 ...
                 var previewimage = function(input,output){
