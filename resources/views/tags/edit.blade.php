                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3 form-group">                                   
                            ...
                            <label for="image" class="gallery">
                                ...
                                @if($tag->image)
                                    <img src="{{asset($tag->image)}}" alt="{{$tag->slug}}" class="img-thumbnail" width="100" height="100" />
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-sm rounded-0" placeholder="Enter Tag Name" value="{{old('name',$tag->name)}}" />
                        </div>
